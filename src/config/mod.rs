...
const ANCHOR_DEF_SVG_PATH: &str = "components/anchor_def_svg.html";
const ANCHOR_GOTO_PATH: &str = "components/anchor_goto.html";
const ANCHOR_GOTO_SVG_PATH: &str = "components/anchor_goto_svg.html";
    ...
    pub fn path_ref(&'a self, path: &Path) -> Option<Arc<Path>> {
        if path.starts_with(self.typst_path) {
            ...
            match path_str.as_str() {
                ...
                ANCHOR_DEF_SVG_PATH => Some(self.anchor.define_in_svg.path.clone()),
                ANCHOR_GOTO_PATH => Some(self.anchor.goto.path.clone()),
                ANCHOR_GOTO_SVG_PATH => Some(self.anchor.goto_in_svg.path.clone()),
